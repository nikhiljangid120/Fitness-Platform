...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      ...
      <section className="relative py-20 md:py-32 px-4 sm:px-6 lg:px-8 overflow-hidden perspective-1000">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="text-white transform-style-3d">
              <div className="inline-block mb-4 bg-white/10 backdrop-blur-sm px-3 py-1 rounded-full">
              ...
              <h1 className="text-5xl md:text-7xl font-extrabold mb-6 animate-fade-in glowing-text">
                FlexForge
                <span className="block text-2xl md:text-3xl mt-2 text-white/90">
                  Transform Your Body, Transform Your Life
                </span>
              </h1>
              <p className="text-lg md:text-xl mb-8 text-white/80 animate-fade-in animation-delay-1">
              ...
              <div className="flex flex-wrap gap-4 animate-fade-in animation-delay-2">
                <Button
                  asChild
                  size="lg"
                  className="bg-white text-primary hover:bg-white/90 shadow-neon transition-all duration-300 hover:scale-105 hover:rotate-1 rounded-full font-medium"
                >
                  <Link href="/workouts">
                ...
                <Button
                  ...
                  variant="outline"
                  size="lg"
                  className="border-white text-white hover:bg-white/10 transition-all duration-300 hover:scale-105 backdrop-blur-sm hover:-rotate-1 rounded-full font-medium"
                >
              ...
              {/* Trust badges */}
              <div className="mt-8 pt-6 border-t border-white/20 flex flex-wrap gap-4 items-center animate-fade-in animation-delay-3">
                ...
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-white" />
                  <span className="text-white/80 text-sm">No Credit Card</span>
                </div>
                <div className="flex items-center gap-2">
                  <CheckCircle className="h-5 w-5 text-white" />
              ...
              <div className="relative w-full max-w-md animate-float animation-delay-3">
                <div className="relative rounded-lg overflow-hidden group">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <Button className="bg-white/90 hover:bg-white text-primary rounded-full flex items-center gap-2">
                ...
                {/* Floating badge */}
                <div className="absolute -bottom-2 -right-2 bg-white shadow-xl rounded-lg p-2 animate-float animation-delay-5">
                  <div className="flex items-center gap-2">
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="flex flex-col items-center">
              ...
              <div className="text-gray-600">Unique Workouts</div>
            </div>
            <div className="flex flex-col items-center">
        ...
        <div className="container max-w-7xl mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-4 md:gap-8 lg:gap-16">
            <div className="feature-icon-hover group">
              <div className="flex items-center gap-3 px-4 py-3 rounded-full bg-white shadow-md transition-all duration-300 group-hover:shadow-lg">
                ...
                <span className="font-medium whitespace-nowrap">500+ Workouts</span>
              </div>
            </div>
            <div className="feature-icon-hover group">
              <div className="flex items-center gap-3 px-4 py-3 rounded-full bg-white shadow-md transition-all duration-300 group-hover:shadow-lg">
                ...
                <span className="font-medium whitespace-nowrap">AI Coaching</span>
              </div>
            </div>
            <div className="feature-icon-hover group">
              <div className="flex items-center gap-3 px-4 py-3 rounded-full bg-white shadow-md transition-all duration-300 group-hover:shadow-lg">
                ...
                <span className="font-medium whitespace-nowrap">Nutrition Plans</span>
              </div>
            </div>
            <div className="feature-icon-hover group">
              <div className="flex items-center gap-3 px-4 py-3 rounded-full bg-white shadow-md transition-all duration-300 group-hover:shadow-lg">
                ...
                <span className="font-medium whitespace-nowrap">Progress Tracking</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white section-fade-in">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 max-w-4xl mx-auto bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-6 shadow-lg">
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-orange-50 to-red-50 section-fade-in">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
              ...
              <Card key={index} className="overflow-hidden hover:shadow-lg transition-all duration-300 group border border-gray-200">
                <Link href={tool.href}>
                  <CardContent className="p-6">
                    <div className="mb-4 w-12 h-12 rounded-full bg-white flex items-center justify-center shadow-md group-hover:shadow-lg group-hover:scale-110 transition-all duration-300">
                      {tool.icon}
                    </div>
          ...
          <div className="mt-16 bg-gradient-to-br from-orange-100 to-red-100 rounded-3xl overflow-hidden">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="p-8 md:p-12 flex flex-col justify-center">
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-4">Take FlexForge Everywhere</h3>
                <p className="text-lg text-gray-700 mb-6">Download our mobile app to track workouts, log nutrition, and get coaching on the go. Available for iOS and Android.</p>
