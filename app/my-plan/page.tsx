...
export default function MyPlanPage() {
  ...
  // Sample workout plan - in a real app, this would be personalized
  const workoutPlan = [
  ...
  // Sample meal plan - in a real app, this would be personalized
  const mealPlan = mealPlans[0]

  // Calculate progress percentage
  const weightLossProgress = Math.round(
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    {[
                      ...
                      { title: "Week Streak", description: "Worked out for 7 days in a row", unlocked: true },
                      { title: "Nutrition Master", description: "Followed meal plan for 14 days", unlocked: false },
                      { title: "Weight Goal", description: "Reached your target weight", unlocked: false },
