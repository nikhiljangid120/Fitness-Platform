...
import { ArrowRight, ArrowLeft, Check, Activity, Dumbbell, Target, Users, Zap, TrendingUp } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { cn } from "@/lib/utils"
// import { saveOnboardingData } from "@/app/actions/user" // Dynamic import used in original, keeping it consistent or importing directly if safely doable. 
// Better to direct import server actions in client components (Next.js supports this).
                ...
                <div className="flex h-full min-h-[600px] flex-col md:flex-row">
                    ...
                    <div className="flex-1 p-8 md:p-12 flex flex-col">
                        ...
                        <div className="mt-auto pt-8 flex justify-between items-center">
                            ...
                            <Button onClick={handleNext} disabled={isSaving} size="lg" className="rounded-full px-8 shadow-lg shadow-primary/25">
                                {isSaving ? "Saving..." : (step === 4 ? "Complete Setup" : "Continue")} {step < 4 && <ArrowRight className="ml-2 h-4 w-4" />}
                            </Button>
                        </div>
                    </div>
                </div>
